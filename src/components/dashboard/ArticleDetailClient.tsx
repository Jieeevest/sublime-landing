...
export default function ArticleDetailClient({
  ...
  const handleShare = (platform: "facebook" | "twitter" | "copy") => {
    ...
    const title = article?.title || "Artikel Strovia";
        ...
        <div className="max-w-4xl mx-auto px-8 py-12">
          ...
          <div className="flex items-center justify-between mb-8 pb-8 border-b border-gray-200">
            ...
            <div className="flex items-center gap-2">
              <button onClick={() => handleShare("facebook")} className="w-10 h-10 flex items-center justify-center rounded-full border border-gray-300 hover:bg-gray-100 transition-colors">
                <svg
              ...
              <button onClick={() => handleShare("twitter")} className="w-10 h-10 flex items-center justify-center rounded-full border border-gray-300 hover:bg-gray-100 transition-colors">
                <svg
                  className="w-5 h-5 text-secondary"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <button onClick={() => handleShare("copy")} className="w-10 h-10 flex items-center justify-center rounded-full border border-gray-300 hover:bg-gray-100 transition-colors">
                <svg
                  className="w-5 h-5 text-secondary"
                  fill="none"
                  viewBox="0 0 24 24"
