...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-teal-300 via-teal-400 to-teal-300 overflow-hidden min-h-screen">
      {/* Navbar */}
      <Navbar />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center justify-between">
          ...
          <div className="text-white space-y-6 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button variant="primary" className="bg-teal-600 hover:bg-teal-700 text-white shadow-lg">
                Get Started
              </Button>
              <Button variant="secondary" className="bg-white/90 hover:bg-white text-teal-700 shadow-lg">
          ...
          <div className="relative">
            ...
            <div className="absolute top-0 right-0 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-4 w-64 z-20 animate-fade-in">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-semibold text-gray-700">Suggested Sounds</h3>
                <button className="text-teal-600 text-xs font-medium hover:text-teal-700">Show All</button>
              </div>
              <div className="bg-gradient-to-br from-teal-800 to-teal-900 rounded-xl p-4 relative overflow-hidden">
                <div className="absolute inset-0 bg-black/20"></div>
                <div className="relative z-10">
                  <p className="text-white text-xs mb-2">Stroke Recovery Calm 432Hz</p>
            ...
            <div className="absolute bottom-0 right-0 space-y-3 w-72 z-20 animate-fade-in">
              <div className="bg-teal-600 rounded-2xl shadow-xl p-5">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-5 space-y-3">
                <p className="text-gray-500 text-sm italic">My body restores itself gently.</p>
                <p className="text-gray-900 font-semibold">I honor my healing pace.</p>
                <p className="text-gray-500 text-sm">Every small step is progress.</p>
              </div>
            </div>
          </div>
        </div>
