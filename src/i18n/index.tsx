...
const dict: Dict = {
  id: {
    ...
    audio_form_label_lyrics: "Lyrics",
    audio_form_placeholder_lyrics:
      "Masukkan lirik audio (opsional)...",
    ...
    audio_uploading_audio: "Sedang upload audio...",
    ...
    ai_suggestion_2: "Bantu aku tetap tenang hari ini.",
    ai_suggestion_3: "Bagaimana cara kerja afirmasi?",
    ai_suggestion_4: "Aku merasa cemas akhir-akhir ini.",
    ai_payment_success: "Pembayaran anda sedang berhasil diproses.",
    ai_input_placeholder: "Ketik pesan Anda di sini...",
    ai_upload_tooltip: "Tambah gambar atau audio",
    ai_record_tooltip: "Mulai rekam suara",
  ...
  en: {
    ...
    audio_form_label_lyrics: "Lyrics",
    audio_form_placeholder_lyrics: "Enter audio lyrics (optional)...",
    ...
    audio_uploading_audio: "Uploading audio...",
    ...
    ai_suggestion_2: "Help me stay calm today.",
    ai_suggestion_3: "How do affirmations work?",
    ai_suggestion_4: "I've been feeling anxious lately.",
    ai_payment_success: "Your payment is being successfully processed.",
    ai_input_placeholder: "Type your message here...",
    ai_upload_tooltip: "Add image or audio",
    ai_record_tooltip: "Start voice recording",
    ai_send_tooltip: "Send message",
